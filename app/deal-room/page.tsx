...
const DUMMY_DEALS = [
  { id: 1, address: '8901 Piedmont Ave, Atlanta GA', dealScore: 92, ask: 195000, arv: 310000, spread: 90000, status: 'LIVE',
    dealType: 'WHOLESALE', contractStatus: 'ASSIGNABLE', photos: ['https://picsum.photos/400/300?10'], notes: 'Hot deal.' },
  { id: 2, address: '234 Cascade Rd, Atlanta GA', dealScore: 78, ask: 245000, arv: 325000, spread: 65000, status: 'UNDER_CONTRACT',
    dealType: 'FLIP', contractStatus: 'DOUBLE_CLOSE', photos: ['https://picsum.photos/400/300?13'], notes: 'Buyer found.' },
  { id: 3, address: '555 Sold St, Atlanta GA', dealScore: 95, ask: 150000, arv: 280000, spread: 110000, status: 'SOLD',
    dealType: 'WHOLESALE', contractStatus: 'ASSIGNABLE', photos: ['https://picsum.photos/400/300?20'], notes: 'Made 25k fee.' },
  { id: 4, address: '777 Arch Ave, Atlanta GA', dealScore: 60, ask: 300000, arv: 320000, spread: 5000, status: 'ARCHIVED',
    dealType: 'FLIP', contractStatus: 'ASSIGNABLE', photos: ['https://picsum.photos/400/300?21'], notes: 'Spread too thin.' },
  { id: 5, address: '999 Del St, Atlanta GA', dealScore: 40, ask: 400000, arv: 390000, spread: -10000, status: 'DELETED',
    dealType: 'WHOLESALE', contractStatus: 'ASSIGNABLE', photos: ['https://picsum.photos/400/300?22'], notes: 'Upside down.' },
]

const TABS = ['LIVE','UNDER_CONTRACT','SOLD','ARCHIVED','DELETED']
            ...
            {filteredDeals.map(deal => (
              <div key={deal.id} onClick={() => setSelected(deal)} 
                ...
                <div className="p-3">
                  ...
                  <div className="text-xs text-gray-500 mt-1">{deal.dealType} | {deal.contractStatus}</div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-2 border-yellow-500 bg-[#1A1A1A]">
            ...
            <div className="flex gap-2 p-3 border-t border-yellow-500">
              ...
              <button onClick={() => updateStatus(selected.id, 'SOLD')} className="flex-1 bg-green-800 py-2 text-xs">SOLD</button>
