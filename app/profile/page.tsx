...
function saveProfile(profile: MemberProfile) {
  ...
  // Strip photos from main profile object BEFORE saving - this is the fix
  ...
  // Save text-only profile to all main keys
  let saved = true;
  for (const key of PROFILE_KEYS) {
    saved = writeJson(key, textOnlyProfile) && saved;
  }

  // Save slim version to directory - photos use placeholder tokens
