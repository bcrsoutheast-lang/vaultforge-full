...
export default function RoomPage() {
  ...
  const title = "Signal Room " + (id || "");
  const sourceRoute = `/signals/${encodeURIComponent(id)}`;

  return (
    <main style={page}>
      <div style={wrap}>
        <section style={panel}>
          <div style={label}>VaultForge Signal Room</div>
          ...
          <p style={{ color: "#cbd5e1", lineHeight: 1.65, fontSize: 20, marginTop: 0 }}>
            Signal is the intelligence trigger workspace. It is not storage.
          </p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginTop: 16 }}>
            <Link href="/intelligence" style={ghost}>Back To Lane</Link>
        ...
        <VaultForgeSignalCommandStack signal={{ id, title }} signalId={id} />
