...
export default function LanePage() {
  return (
    <VaultForgeCommandShell
      active="alerts"
      title="Alert Room."
      subtitle="Unread triggers, new matches, pressure warnings, routing notices, and message signals live here."
    >
      <section style={panel}>
        ...
        >
          Alerts are not storage. Alerts are triggers. Click an alert, stop the flash, open the correct room, then save, archive, or delete/hide the room from active workflow.
        </p>
        ...
        >
            <Link href="/alerts?lane=new" style=button>
              New Alerts
            </Link>
