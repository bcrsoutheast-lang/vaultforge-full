...
const { data, error } = await supabase.from('vf_message_command_messages').insert({ thread_key, subject, body, lane, members, from_email: session.user.email }).select().single()
