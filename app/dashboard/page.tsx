...
export default function Dashboard() {
  ...
  async function loadSummary() {
    ...
    try {
      const res = await fetch("/api/dashboard/summary", { cache: "no-store", headers: authHeaders() });
  ...
  return (
    <main style={shellStyle}>
      <nav style={navStyle}>
        ...
        <button onClick={logout} style={{ ...navLinkStyle, background: "transparent", cursor: "pointer" }}>Logout</button>
      </nav>
