...
const DUMMY_LEADS = [
  { id: 1, address: '7420 N Decatur Rd, Atlanta GA', psScore: 92, ask: 89000, arv: 220000, 
    motivation: 'T', condition: 'POOR', occupancy: 'VACANT', status: 'NEW', 
    owner: 'John Smith', phone: '404-555-1212', photos: ['https://picsum.photos/400/300?1'],
    notes: 'Tax delinquent. Needs roof.' 
  },
  { id: 2, address: '1421 Pine St, Atlanta GA', psScore: 78, ask: 125000, arv: 180000,
    motivation: 'D', condition: 'FAIR', occupancy: 'OWNER', status: 'SAVED', 
    owner: 'Jane Doe', phone: '678-555-3434', photos: ['https://picsum.photos/400/300?3'],
    notes: 'Divorce. Motivated.'
  },
  { id: 3, address: '9900 Oak Ave, Atlanta GA', psScore: 65, ask: 200000, arv: 250000,
    motivation: 'M', condition: 'GOOD', occupancy: 'TENANT', status: 'UNDER_CONTRACT', 
    owner: 'Bob Jones', phone: '770-555-5656', photos: ['https://picsum.photos/400/300?4'],
    notes: 'Moving out of state.'
  },
  { id: 4, address: '123 Main St, Atlanta GA', psScore: 88, ask: 95000, arv: 200000,
    motivation: 'PR', condition: 'POOR', occupancy: 'VACANT', status: 'CLOSED', 
    owner: 'Mary Johnson', phone: '404-555-7878', photos: ['https://picsum.photos/400/300?5'],
    notes: 'Closed 5/15. Made 40k.'
  },
  { id: 5, address: '555 Elm Rd, Atlanta GA', psScore: 45, ask: 180000, arv: 190000,
    motivation: 'F', condition: 'EXCELLENT', occupancy: 'OWNER', status: 'ARCHIVED', 
    owner: 'Steve Ray', phone: '678-555-9090', photos: ['https://picsum.photos/400/300?6'],
    notes: 'Not motivated. Low equity.'
  },
  { id: 6, address: '777 Dead St, Atlanta GA', psScore: 30, ask: 300000, arv: 290000,
    motivation: 'M', condition: 'EXCELLENT', occupancy: 'OWNER', status: 'DELETED', 
    owner: 'Karen White', phone: '770-555-0000', photos: ['https://picsum.photos/400/300?7'],
    notes: 'Waste of time.'
  },
]

const TABS = ['NEW','SAVED','UNDER_CONTRACT','CLOSED','ARCHIVED','DELETED']
...
export default function PainRoom() {
  ...
  const updateStatus = (id: number, newStatus: string) => {
    ...
    setMessage(`LEAD MOVED TO ${newStatus}`)
      ...
      {!selected? (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-2 border-yellow-500 bg-[#1A1A1A]">
            <div className="bg-yellow-600 text-black p-3 font-bold">LEAD DETAIL // PS: {selected.psScore}</div>
            ...
            <div className="grid grid-cols-3 gap-2 p-3 border-t border-yellow-500">
              ...
              <button onClick={() => updateStatus(selected.id, 'CLOSED')} className="bg-green-800 py-2 text-xs">CLOSED</button>
              ...
              <button onClick={() => updateStatus(selected.id, 'NEW')} className="bg-yellow-600 text-black py-2 text-xs">BACK TO NEW</button>
            </div>
          </div>
        </div>
      )}
