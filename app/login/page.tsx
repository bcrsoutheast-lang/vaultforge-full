      ...
      <section style={cardStyle}>
        <div style={{ textAlign: "center", marginBottom: 22 }}>
          <img
            ...
            alt="VaultForge"
            style={{ width: "100%", maxWidth: 340, borderRadius: 18 }}
          />
        </div>
        ...
        <h1 style={{ fontSize: 46, lineHeight: 1, margin: "10px 0 18px" }}>
          Enter VaultForge
        </h1>
        <p style={{ color: "rgba(255,255,255,.72)", lineHeight: 1.5 }}>
          Use the same email for your profile, deals, buy bucket, alerts, and messages.
        </p>
        ...
        <p style={{ color: "rgba(255,255,255,.55)", marginTop: 18 }}>
          ...
          <Link href="/terms" style={linkStyle}>Read terms</Link>
        </p>
      </section>
    </main>
  );
