...
export const dynamic = 'force-dynamic' // <-- This kills the build error
...
function MessagesContent() {
  ...
  // Pull owner from URL - THIS IS THE KEY
  useEffect(() => {
  ...
  ...f,
      ...
      recipient: urlRecipient, // If blank, stays blank
  ...
  async function handleSendMessage() {
    if (!form.from || form.from === 'Not logged in') return alert('Login required to send')
    if (!form.recipient) return alert('Owner email missing - come from a deal page')
        ...
        <div className="vf-card">
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'12px',marginTop:'12px'}}>
            ...
            <div style={{border:'1px solid rgba(148,163,184,.18)',borderRadius:'16px',padding:'12px'}}>
              ...
              <div style={{fontWeight:900,marginTop:'4px'}}>{form.recipient || 'No owner email'}</div>
              <div style={{fontSize:'12px',color:'#94a3b8',marginTop:'4px'}}>
                {form.recipient? 'Deal owner' : 'Missing?recipient= in URL'}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="vf-card">
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:'12px',marginTop:'12px'}}>
          ...
          <div>
            ...
            <input className="vf-input" value={form.recipient} readOnly placeholder="Comes from deal URL" />
          </div>
          <div>
      ...
      <div className="vf-card">
        ...
        {filteredThreads.length === 0? (
          <div>
            ...
            <p style={{color:'#94a3b8'}}>Click Message on a deal to start a thread with the owner.</p>
          </div>
        ) : (
