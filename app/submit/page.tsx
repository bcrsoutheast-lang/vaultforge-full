...
export default function SubmitPage() {
  ...
  return <main style={page}><div style={wrap}>
    ...
    <section style={card}><div style={eyebrow}>CONTEXT</div>
      <TextAreaField label="Description / Deal Summary" value={form.description} onChange={v=>set("description",v)} />
      <TextAreaField label="Seller Situation" value={form.seller_situation} onChange={v=>set("seller_situation",v)} />
      <TextAreaField label="Access Notes" value={form.access_notes} onChange={v=>set("access_notes",v)} />
      <TextAreaField label="Private Notes" value={form.private_notes} onChange={v=>set("private_notes",v)} />
    </section>
