      ...
      <div style={wrap}>
        ...
        <section style={hero}>
          <div>
            ...
            <p style={sub}>
              Sequence: alerts pulse first, tickets tell what needs action, rooms carry the work, messages close the loop.
            </p>
          </div>
        </section>
...
const redLane: React.CSSProperties = {
  borderColor: "rgba(255,70,70,.34)",
  background: "linear-gradient(180deg,#17070d,#050816)",
};

const laneCopy: React.CSSProperties = {
  color: "#c9d0dc",
  fontSize: 18,
  lineHeight: 1.4,
  margin: "0 0 18px",
