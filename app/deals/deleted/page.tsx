  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh', color: '#E5E5E5', padding: '24px' }}>
      <header style={{ 
        ...
        <div>
          <div style={{ color: '#FF6B6B', fontSize: '24px', fontWeight: '900', letterSpacing: '2px' }}>
            RECYCLE BIN
          </div>
          <div style={{ color: '#666', fontSize: '11px', letterSpacing: '2px' }}>
            DELETED DEALS. 30-DAY RECOVERY. DELETE FOREVER.
          </div>
        </div>
            ...
            return (
              <tr key={deal.id} style={{ borderBottom: '1px solid #222', opacity: daysLeft === 0 ? 0.5 : 1 }}>
                ...
                <td style={{ padding: '16px', display: 'flex', gap: '8px' }}>
                  ...
                  <button 
                    onClick={() => deleteForever(deal.id, deal.title)} 
                    style={{ 
                      border: '1px solid #FF6B6B', 
                      background: 'transparent', 
                      color: '#FF6B6B', 
