...
function defaultMessage(action: string) {
  ...
  if (a === "save") return "Save this alert to my VaultForge activity and keep it visible for follow-up.";
...
export default function AlertActionClient({ actionName }: { actionName: string }) {
  const action = normalizedAction(actionName);
