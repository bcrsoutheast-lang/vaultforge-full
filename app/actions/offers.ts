...
export async function submitOffer(formData: FormData) {
  ...
  // Basic validation - stop tire kickers
  ...
  // TODO: Add email/text notification here with Resend or Twilio
  // await sendEmail({ to: 'dm2107137@gmail.com', subject: `New Offer: $${offer_price} on ${deal_address}` })

  revalidatePath('/deal-opportunities')
  revalidatePath('/my-work/offers') // for your dashboard later
